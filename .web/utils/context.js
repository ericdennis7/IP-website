...
export const initialState = {"state": {"is_hydrated": false, "router": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": ""}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}}}, "state.on_load_internal_state": {}, "state.form_input_state1": {"loading": false, "ping_results": {"columns": [], "data": []}, "show_data": false, "show_initial": true}, "state.update_vars_internal_state": {}, "state.form_input_state": {"loading": false, "ping_results": {"columns": [], "data": []}, "show_data": false, "show_initial": true}}
...
export const StateContexts = {
  ...
  state__form_input_state1: createContext(null),
...
export function StateProvider({ children }) {
  ...
  const [state__form_input_state1, dispatch_state__form_input_state1] = useReducer(applyDelta, initialState["state.form_input_state1"])
  ...
  const dispatchers = useMemo(() => {
    return {
      ...
      "state.form_input_state1": dispatch_state__form_input_state1,
  ...
  return (
    ...
    <StateContexts.state__form_input_state1.Provider value={ state__form_input_state1 }>
    ...
    </StateContexts.state__form_input_state1.Provider>
